...
namespace Schedule.VkApi.Bot
{
	public class ScheduleBot
	{
		...
		private string GetSelectedDayOfWeekSchedule(BotCommandType selectedCommandType, BotCommandType writedCommandType)
		{
			var sb = new StringBuilder();
		...
		private string GetDayOfOfWeekSchedule(DataTable dataTable, BotCommandType selectedCommandType)
		{
			var sb = new StringBuilder();
			var columnOfDay = (int)selectedCommandType;
			var count = 0;
		...
		private string GetWeekSchedule(DataTable dataTable, BotCommandType commandType)
		{
			var sb = new StringBuilder();
